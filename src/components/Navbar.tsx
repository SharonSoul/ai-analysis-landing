...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-24 lg:px-40 py-4 md:py-6 w-full transition-all duration-300 ${
        scrolled ? 'bg-white/80 backdrop-blur-lg shadow-sm border-b border-white/20 py-4' : 'bg-transparent py-6 md:py-8'
      }`}
    >
